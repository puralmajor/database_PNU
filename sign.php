...
<body>
    <form action="signProcess.php" method="POST" id="signup-form">
        ...
        <div class="mb-3">
            <label for="id" class="form-label">교도관번호</label>
            <input type="id" name="PO_id" class="form-control" id="PO_id" placeholder="교도관 번호를 입력하세요">
        </div>
        <div class="mb-3">
            <label for="id" class="form-label">이름</label>
            <input type="id" name="PO_name" class="form-control" id="PO_name" placeholder="교도관 번호를 입력하세요">
        </div>
        <div class = "mb-3">
            <label for ="password" class="form-label"> 비밀번호 </label>
            <input name="password" type="PO_password" class="form-control" id="PO_password" placeholder="비밀번호를 입력해 주세요.">
            </div>
            <div class="mb-3 ">
